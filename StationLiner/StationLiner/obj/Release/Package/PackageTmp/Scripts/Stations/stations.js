...
//        $.confirm({
//            title: 'Confirm!',
//            content: 'Do you want to proceed to tank calibration!',
//            confirm: function () {
//                alert('confirmed');
//                return window.location.href = "/Stations/CalibrationChart/1";
//            },
//            cancel: function () {
//                window.location.href = "/Stations";
//            }
...
$('a#complete-add-stn').on('click',
    function () {
        ...
        if (stationId == "") {
            ...
            $.confirm({
                title: 'Confirm!',
                content: 'Do you want to configure tank calibration now?',

                buttons: {
                    Yes: function() {
                        window.location.href = "/Stations/CalibrationChart?id="+stationId;
                    },
                    Later: function() {
                        window.location.href = "/Stations";
                    }
